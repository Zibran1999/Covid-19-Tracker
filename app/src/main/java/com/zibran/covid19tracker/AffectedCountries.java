...
import com.zibran.covid19tracker.adapters.MyCustumAdapter;
...
public class AffectedCountries extends AppCompatActivity {
    ...
    MyCustumAdapter myCustomAdapter;
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url,
            ...
            countryModelsList.clear();
                    try {
                        ...
                        myCustomAdapter = new MyCustumAdapter(AffectedCountries.this, countryModelsList);
